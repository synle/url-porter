...
description: Trigger the official release workflow for URL Porter. Bumps version, builds, and creates a GitHub release.
user_invocable: true
---

# Release Official

Trigger the official release workflow (`release-official.yml`) for URL Porter.
...
3. Trigger the workflow:
   - If the user provided notes: `gh workflow run release-official.yml -f notes="<user notes>"`
